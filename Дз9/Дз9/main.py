...
print("Максимальное (слово: кол-во):", max(dictionary, key=dictionary.get), ':', max(dictionary.values()))
print("Минимальное (слово: кол-во):", min(dictionary, key=dictionary.get), ':', min(dictionary.values()))
